...
```
## Finding 3: The tates with the most guns report the most suicides
### Vox Version
![](images/suicide.png)
...
### Reasoning
The Vox plot is not straight forward in terms of readiness and is not convincing. On the one hand, it is really hard to understand what the bars are showing and how to compare the four bars. Further, showing the highest/lowest gun ownership states are not convincing as these states can just be outliers or there might be a u-shape in the general trend so the conclusion is misleading. To tackle these two problems, all states' gun ownership vs. gun suicide rate are displayed in the revised plot. 
...
red, standing out, data pixel ratio
switch y axis and x axis more readible to audience
